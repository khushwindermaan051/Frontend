    ...
    <div className="uploader-root">
      ...
      <div className={`tab-panel ${activeTab === 'paste' ? 'active' : ''}`}>
        ...
        <div className="btn-row">
          ...
          <button className="btn btn-secondary" onClick={() => { setPasteText(''); setPasteData([]); setPasteMsg(null); setAmazonDetected(EMPTY_AMAZON); }} disabled={pasteLoading}>Clear</button>
        </div>
        {pasteData.length > 0 && (
          <div>
        ...
        {csvData.length > 0 && (
          <div>
            ...
            <div>
              ...
              <button className="btn btn-secondary" onClick={() => { setCsvData([]); setCsvMsg(null); setAmazonDetected(EMPTY_AMAZON); }} disabled={csvLoading}>Clear</button>
            </div>
          </div>
        )}
